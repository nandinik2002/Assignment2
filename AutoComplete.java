...
import java.util.ArrayList;
 ...
 public class AutoComplete implements AutoCompleteInterface {
  ...
  public boolean add(String word) {
    ...
    } else return addWord(root, word, 0) != null;
  }
  ...
  public void retreat() {
    ...
    if(currentPrefix.length() > 0){
      ...
      throw new IllegalStateException("Current prefix is already empty");
    }
  }
  ...
  public String retrievePrediction() {
    ...
    if(currentNode == null || !currentNode.isWord && currentNode.child == null){
      return null;
    }
